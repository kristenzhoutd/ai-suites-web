        ...
        {!isApproved ? (
          <>
            ...
            <button
              ...
              disabled={!isInitialized}
              className="px-5 py-2 bg-[#212327] border-none rounded-lg text-sm font-medium text-white cursor-pointer hover:bg-[#3a3d42] transition-colors disabled:opacity-40 disabled:cursor-not-allowed"
            >
              Approve Plan
            </button>
          </>
          ...
          <>
            ...
            <button
              ...
              disabled={activeTab !== 'meta' && activeTab !== 'google'}
            ...
            >
              <img
                src={activeTab === 'google' ? '/assets/google-ads.png' : '/assets/meta-ads.png'}
                alt=""
                className="w-4 h-4"
              />
