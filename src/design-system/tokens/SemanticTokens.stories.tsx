...
const tokenGroups = {
  Surface: [
    ...
    { name: '--surface-tag-success', value: '#e7f7f1', alias: 'success-1' },
    { name: '--surface-tag-warning', value: '#fee5b7', alias: 'warning-3' },
    { name: '--surface-tag-error', value: '#fdecec', alias: 'error-1' },
    { name: '--surface-tag-neutral', value: '#f2f3f3', alias: 'neutral-1' },
    { name: '--surface-tag-primary', value: '#f2f5fe', alias: 'primary-0' },
    { name: '--surface-tag-purple', value: '#ffffff', alias: '' },
    { name: '--surface-tag-teal', value: '#ffffff', alias: '' },
  ...
  Text: [
    ...
    { name: '--text-tag-success', value: '#0a6a47', alias: 'success-8' },
    ...
    { name: '--text-tag-purple', value: '#645396', alias: 'amethyst-8' },
    { name: '--text-tag-teal', value: '#bc667c', alias: 'morganite-7' },
  ],
  Icon: [
    ...
    { name: '--icon-error', value: '#bf3636', alias: 'error-7' },
    { name: '--icon-tag-success', value: '#0a6a47', alias: 'success-8' },
    ...
    { name: '--icon-tag-teal', value: '#bc667c', alias: 'morganite-7' },
  ],
};
