...
description: >
  ...
  and measurement sections. Use this skill whenever the user mentions campaigns,
  promotions, sales, marketing initiatives, or describes targeting audiences with
  personalized content, even if they don't explicitly ask for a "campaign brief".
---
...
4. **Unique copy per spot.** Every `spotCreative` entry must have distinct
...
### Example 2: With Available Pages (spotCreatives)
